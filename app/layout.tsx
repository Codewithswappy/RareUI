...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "RareUI - Premium React UI Components Library | Free & Open Source | Tailwind CSS",
    template: "%s | RareUI - Free React UI Component Library",
  },

  description:
    "Discover 100+ premium, free, and open-source React UI components. Built with Tailwind CSS, Next.js, and Framer Motion. Copy-paste ready components for building modern web applications. Download buttons, cards, forms, modals, navbars, and more. No installation required - just copy and use.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Discover 100+ premium, free, and open-source React UI components. Built with Tailwind CSS, Next.js, and Framer Motion.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "RareUI - Premium React UI Components Library",
    description:
      "Premium, free, and open-source React UI components. Built with Tailwind CSS, Next.js, and Framer Motion.",
              ...
              "@graph": [
                {
                  ...
                  name: "RareUI",
                  description:
                    "Premium free React UI component library with 100+ components",
                  publisher: {
                  ...
                  potentialAction: [
                    {
                      ...
                      target: {
                        "@type": "EntryPoint",
                        urlTemplate:
                          "https://rareui.in/docs?search={search_term_string}",
                      },
                ...
                },
                {
                  ...
                  releaseNotes:
                    "Initial release with 8 premium component categories",
                  url: "https://rareui.in",
                },
                {
                  "@type": "ItemList",
                  ...
                  description:
                    "Categories of React UI components available in RareUI",
                  itemListElement: [
                    {
                      "@type": "ListItem",
                      position: 1,
                      ...
                      description:
                        "Premium animated buttons including Liquid Button, Glass Shimmer, Soft Button, and more",
                    },
                    {
                      "@type": "ListItem",
                      position: 2,
                      ...
                      description:
                        "Interactive cards with particle effects, profile cards, and premium designs",
                    },
                    {
                      "@type": "ListItem",
                      position: 3,
                      ...
                      description:
                        "Smooth animations powered by Framer Motion for modern web experiences",
                    },
                  ],
                },
                {
