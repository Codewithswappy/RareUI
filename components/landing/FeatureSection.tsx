    ...
    <section className="bg-background relative pt-20 pb-32 px-4 md:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none select-none z-0">
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Desktop Grid */}
          <rect x="10%" y="0" width="80%" height="100%" fill="url(#feature-grid-pattern)" className="hidden md:block" />
          ...
          {/* Mobile Grid */}
          <rect x="2.5%" y="0" width="95%" height="100%" fill="url(#feature-grid-pattern)" className="block md:hidden" />
       ...
       <div className="max-w-[1400px] w-[95%] md:w-[80%] mx-auto relative z-10 pt-20">
          {/* Header */}
