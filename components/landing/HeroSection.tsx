  ...
  return (
    <div className="relative w-full overflow-hidden font-sans transition-colors duration-300 bg-background text-foreground selection:bg-primary/20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none select-none">
        <svg className="absolute inset-0 w-full h-full opacity-[0.3] dark:opacity-[0.3]" xmlns="http://www.w3.org/2000/svg">
          <defs>
          ...
          <rect x="10%" y="0" width="80%" height="100%" fill="url(#grid-pattern)" /> 
          ...
          >
           ...
           <div className="flex items-center justify-center">
             <div className="flex flex-wrap items-center justify-center gap-5 md:gap-10 ">
               {/* React */}
               <div className="flex items-center justify-center w-10 h-10 group/icon pt-10 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-500" title="React">
               ...
               {/* Tailwind CSS */}
               <div className="flex items-center justify-center w-10 h-10 group/icon pt-10 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-500" title="Tailwind CSS">
               ...
               <div className="flex items-center justify-center h-10 w-10 min-w-[40px] group/icon pt-10 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-500" title="Framer Motion">
               ...
               {/* Next.js */}
               <div className="flex items-center justify-center w-10 h-10 group/icon pt-10 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-500" title="Next.js">
               ...
               {/* TypeScript */}
               <div className="flex items-center justify-center w-10 h-10 group/icon pt-10 md:mr-16 lg:mr-12 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-500" title="TypeScript">
