...
function Word({ word, mouseX, mouseY, radius, force, damping, returnDelay, disabled }: WordProps) {
  ...
  return (
    <motion.span ref={wordRef} className="inline-block whitespace-nowrap" style={{ x, y }}>
      {word}
    </motion.span>
  );
}
