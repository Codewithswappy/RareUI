...
<UsageGuide steps={[
  {
    ...
    code: `import { Book3D } from '@/components/rareui/3d-elements/book-3d';`
  },
  {
...
<FeaturesList features={[
  {
    ...
    description: "Hover to open, click pages to flip."
  },
  {
    title: "Realistic Physics",
    description: "Smooth page-turning animations with natural easing."
  },
  {
    title: "Bi-directional Navigation",
    description: "Click right to advance, click left to go back."
  },
  {
    title: "Smart Defaults",
    description: "Beautiful RareUI branding when no customization provided."
  },
  {
    title: "Fully Customizable",
    description: "Override cover, title, and all page content."
  },
  {
    title: "TypeScript Support",
    description: "Full type safety with defined interfaces."
  },
  {
    title: "Responsive",
    description: "Configurable dimensions to fit your layout."
  }
]} />
...
<PropsTable props={[
  {
    name: "src",
    type: "string",
    description: "Cover image URL. If not provided, shows RareUI branding."
  },
  {
    name: "title",
    type: "string",
    description: "Title displayed on cover."
  },
  {
    name: "subtitle",
    type: "string",
    description: "Subtitle displayed on cover."
  },
  {
    name: "pages",
    type: "PageData[]",
    default: "[...]",
    description: "Array of page content objects. Defaults to RareUI demo pages."
  },
  {
    name: "width",
    type: "number",
    default: "230",
    description: "Book width in pixels."
  },
  {
    name: "height",
    type: "number",
    default: "350",
    description: "Book height in pixels."
  },
  {
    name: "className",
    type: "string",
