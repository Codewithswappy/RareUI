...
description: A sleek, floating navigation bar with fluid hover effects and animated icons.
badge: New
---
...
export default function FloatingNavigation({ items = defaultItems, className }: FloatingNavigationProps) {
  ...
  cliCommand="npx rareui add floating-navigation"
>
...
<UsageGuide steps={[
  {
    ...
    code: `import FloatingNavigation from "@/components/rareui/FloatingNavigation";`
  },
  {
...
<FeaturesList features={[
  {
    ...
    description: "Elegant floating bar that stays accessible without cluttering the screen."
  },
  {
    title: "Smooth Hover Effects",
    description: "Fluid background transitions and scale effects on interaction."
  },
  {
    title: "Animated Icons",
    description: "Unique, playful animations for each icon state."
  },
  {
  ...
  {
    title: "Responsive",
    description: "Adapts perfectly to different screen sizes and themes."
  }
]} />
