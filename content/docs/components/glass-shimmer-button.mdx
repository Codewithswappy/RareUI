...
<UsageGuide steps={[
  {
    ...
    code: `import { GlassShimmerButton } from '@/components/rareui/glass-shimmer-button';`
  },
  {
...
<FeaturesList features={[
  {
    title: "Continuous Shimmer Animation",
    description: "Self-contained animated shimmer effect that runs continuously."
  },
  {
    title: "Glassmorphism Design",
    description: "Premium frosted glass aesthetic with backdrop blur."
  },
  {
    title: "Hover Effects",
    description: "Scale animation and enhanced glow on hover."
  },
  {
  ...
  },
  {
    ...
    description: "No global CSS required - animations defined inline."
  }
]} />
...
<PropsTable props={[
  ...
  },
  {
    ...
    description: "Any additional HTML button attributes (onClick, disabled, etc.)."
  }
]} />
