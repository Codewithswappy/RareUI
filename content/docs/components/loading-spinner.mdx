...
description: A customizable loading spinner with light and dark mode support and smooth animations.
badge: New
---
...
<Preview
  cliCommand="npx rareui add LoadingSpinner"
  code={`"use client";
...
`}>
  <div className="flex h-full w-full min-h-[200px] items-center justify-center p-8">
    <LoadingSpinner />
  </div>
</Preview>
...
<UsageGuide steps={[
  {
    ...
    code: `import LoadingSpinner from "@/components/rareui/LoadingSpinner";`
  },
  {
...
<FeaturesList features={[
  {
    ...
    description: "Fluid continuous rotation using Framer Motion."
  },
  {
    title: "SVG-based",
    description: "Crisp, scalable vector graphics for the spinner."
  },
  {
    title: "Lightweight",
  ...
  {
    title: "Customizable",
    description: "Easily adjust size and colors via className."
  },
  {
    title: "Dark Mode Support",
    description: "Automatically adapts color for light and dark themes."
  }
]} />
