...
<UsageGuide steps={[
  {
    ...
    code: `import RetroPixelButton from '@/components/rareui/retro-pixel-button';`
  },
  {
...
<FeaturesList features={[
  {
    ...
    description: "Font-mono styling with pixelated arrow icon."
  },
  {
    title: "Sliding Animation",
    description: "Smooth spring-based expansion of the pixel block on hover."
  },
  {
    title: "Icon Rotation",
    description: "Pixelated arrow rotates 180° during the hover transition."
  },
  {
    title: "Text Morphing",
    description: "Text subtly blurs and shifts with a glitch-like effect."
  },
  {
    title: "Fully Customizable",
    description: "Control pixel block, base, and text colors independently."
  }
]} />
...
<PropsTable props={[
  ...
  },
  {
    ...
    type: "string",
    default: '"orange"',
    description: "Color of the sliding pixel block."
  },
  {
    name: "baseColor",
    type: "string",
