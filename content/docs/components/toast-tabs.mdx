---
title: Toast Tabs
description: A unique tab switching component that displays content like a toast message, with an animated avatar switcher.
---
...
const CIRCUMFERENCE = 175.929; // 2 _ pi _ 28
...
cliCommand="npx rareui add toast-tabs"
  ...
  steps={[
    {
      ...
      code: `import ToastTabs from "@/components/rareui/ToastTabs";`,
    },
    {
...
<FeaturesList
  features={[
    {
      title: 'Toast-style Content',
      description: 'Displays tab content in a compact, toast-like notification card.',
    },
    {
      title: 'Animated Progress Ring',
      description: 'Visual indicator for autoplay progress around the active tab.',
    },
    {
      title: 'Autoplay',
      description: 'Automatically cycles through tabs with pause-on-hover.',
    },
    {
      title: 'Keyboard Navigation',
      description: 'Full arrow key support for accessible tab switching.',
    },
    {
      title: 'Responsive',
      description: 'Adapts to different screen sizes and themes.',
    },
  ]}
/>
  ...
  props={[
    {
      ...
      type: 'TabData[]',
      default: 'defaultTabs',
      description: 'Array of tab data objects (id, image, title, description).',
    },
    {
      name: 'autoplay',
      type: 'boolean',
      default: 'true',
      description: 'Whether to automatically cycle through tabs.',
    },
    {
      name: 'autoplayDelay',
      type: 'number',
      default: '3000',
      description: 'Duration (ms) for each tab slide.',
    },
    {
      name: 'ringColor',
      type: 'string',
