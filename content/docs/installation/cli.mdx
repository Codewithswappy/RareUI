...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab value="npm">```bash npx rareui@latest add [component-name] ```</Tab>
  <Tab value="pnpm">```bash pnpm dlx rareui@latest add [component-name] ```</Tab>
  <Tab value="yarn">```bash yarn dlx rareui@latest add [component-name] ```</Tab>
  <Tab value="bun">```bash bunx rareui@latest add [component-name] ```</Tab>
</Tabs>
