...
import LiquidWave from '@/components/rareui/LiquidWaveLazy';
  ...
  steps={[
    {
      ...
      code: `import LiquidWave from "@/components/rareui/LiquidWave";`,
    },
    {
...
/>`,
    ...
    {
      title: 'Custom Force and Cursor Size',
      code: `<LiquidWave 
  mouseForce={30}
  cursorSize={150}
/>`,
