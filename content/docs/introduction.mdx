...
- 🐛 **Found a bug?** [Open an issue](https://github.com/Codewithswappy/RareUI/issues/new)
- 💡 **Have an idea?** [Request a feature](https://github.com/Codewithswappy/RareUI/issues/new?labels=enhancement)
