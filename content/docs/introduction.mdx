...
<div className="border-border mt-8 rounded-xl border bg-zinc-50 p-6 dark:bg-zinc-900">
  <div className="text-muted-foreground mb-2 text-sm">Built with ❤️ by</div>
