...
<UsageGuide steps={[
  {
    ...
    code: `import SoundText from "@/components/rareui/SoundText";`
  },
  {
...
<FeaturesList features={[
  {
    ...
    description: "Generates real-time audio frequencies on hover."
  },
  {
    title: "Pentatonic Scale",
    description: "Uses musical scales for harmonious sound generation."
  },
  {
    title: "Interactive Animation",
    description: "Letters jump and glow in sync with the sound."
  },
  {
    title: "Web Audio API",
    description: "Uses native Web Audio API for low-latency sound synthesis."
  },
  {
    title: "Customizable Pitch",
    description: "Adjust the base frequency to change the musical key."
  }
]} />
...
<PropsTable props={[
  ...
  },
  {
    ...
    type: "number",
    default: "300",
    description: "The base frequency in Hz for generating sound scale."
  },
  {
    name: "className",
    type: "string",
