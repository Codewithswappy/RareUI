...
import WordMagnet from '@/components/rareui/WordMagnet';
...
<Preview
  cliCommand="npx rareui add WordMagnet"
  code={`"use client";
...
/**
_ The text content to display
_/
text?: string;
/**
_ Interaction radius in pixels
_/
radius?: number;
/**
_ Repulsion force (0.1 to 1.0)
_/
force?: number;
/**
_ Spring damping (5 to 50)
_/
damping?: number;
/**
_ Delay before returning to original position in ms
_/
returnDelay?: number;
/**
_ Text color
...
textColor?: string;
/**
_ Font styling object
_/
font?: React.CSSProperties;
/**
_ Disable interaction on mobile devices
_/
disableOnMobile?: boolean;
/**
_ CSS overflow property
_/
  ...
  steps={[
    {
      ...
      code: `import WordMagnet from "@/components/rareui/WordMagnet";`,
    },
    {
...
<FeaturesList
  features={[
    {
      title: 'Physics Repulsion',
      description: 'Words are pushed away by the mouse cursor using spring physics.',
    },
    {
      title: 'Smart Recovery',
      description: 'Words smoothly snap back to their original position after interaction.',
    },
    {
      title: 'Interaction Radius',
      description: 'Configurable zone of influence for the magnetic effect.',
    },
    {
      title: 'Performance Optimized',
      description: 'Uses throttling and efficient DOM calculations for smooth 60fps.',
    },
    {
      title: 'Mobile Aware',
      description: 'Optional setting to disable effects on touch devices.',
    },
  ]}
/>
...
<PropsTable
  props={[
    ...
    },
    {
      ...
      type: 'number',
      default: '130',
      description: 'Interaction radius in pixels',
    },
    {
      name: 'force',
      type: 'number',
      default: '0.45',
      description: 'Repulsion force (0.1 to 1.0)',
    },
    {
      name: 'damping',
      type: 'number',
      default: '28',
      description: 'Spring damping (5 to 50)',
    },
    {
      name: 'returnDelay',
      type: 'number',
      default: '400',
      description: 'Delay before returning to original position in ms',
    },
    {
      name: 'textColor',
      type: 'string',
    ...
    },
    {
      name: 'font',
      type: 'object',
      default: "{ fontSize: '32px', ... }",
      description: 'Font styling object',
    },
    {
      name: 'disableOnMobile',
      type: 'boolean',
      default: 'false',
      description: 'Disable interaction on mobile devices',
    },
    {
      name: 'overflow',
      type: 'string',
